...
import styles from './ChatLemon.module.css'
...
import { QuestionInputLemon } from '../../components/QuestionInput/QuestionInputLemon'
import { AnswerLemon } from '../../components/Answer/AnswerLemon'
    ...
    <div className={styles.container} role="main">
      <Stack horizontal className={styles.chatRoot}>
        ...
        {messages && messages.length > 0 && isIntentsPanelOpen && (
          <Stack.Item className={styles.citationPanel} tabIndex={0} role="tabpanel" aria-label={t('chat.intentsPanel')}>
            <Stack
