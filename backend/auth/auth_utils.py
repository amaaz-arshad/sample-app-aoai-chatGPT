...
def get_authenticated_user_details(request_headers):
    user_object = {}
    logging.info("ALL HEADERS:", [k for k in request_headers.keys()])
    ...
    user_object['auth_token'] = raw_user_object.get('X-Ms-Token-Aadb2C-Id-Token')
    user_object['client_principal_b64'] = raw_user_object.get('X-Ms-Client-Principal')
    user_object['aad_id_token'] = raw_user_object.get('X-Ms-Token-Aadb2C-Id-Token')
